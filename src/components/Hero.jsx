	...
	return (
		<div className="max-w-[1400px] w-full mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-12 md:py-24">
			<div>
				...
				<h1 className="text-3xl font-extrabold w-4/5 lg:text-4xl">Save <span className="hover:scale-125 duration-500 text-orange-500 font-extrabold inline-block">big</span> with our car rentals</h1>
